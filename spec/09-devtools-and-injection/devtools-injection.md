...
See **`spec/07-chrome-extension/47-cdp-injection-fallback.md`** for full CDP architecture, `chrome.debugger` vs WebSocket approaches, security considerations, and implementation plan.
