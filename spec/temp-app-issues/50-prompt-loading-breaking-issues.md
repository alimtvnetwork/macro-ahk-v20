...
- `spec/07-chrome-extension/45-prompt-manager-crud.md` — CRUD spec
- `spec/02-app-issues/41-options-ui-and-prompts-critical-issues.md` — Previous Options UI issues
...
- [x] Issue documented under `/spec/02-app-issues/`
