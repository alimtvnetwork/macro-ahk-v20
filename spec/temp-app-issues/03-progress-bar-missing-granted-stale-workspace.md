...
- `/spec/02-app-issues/03-progress-bar-missing-granted-stale-workspace.md` (this file)
- `/spec/06-macro-controller/workspace-detection.md` — Validation rule extended to API fallbacks
