...
- `/spec/02-app-issues/04-workspace-detection-405-api-failure.md` (this file)
- `/spec/06-macro-controller/workspace-detection.md` — Detection chain updated with DOM fallback
