...
- **Spec**: `spec/07-chrome-extension/63-rise-up-macro-sdk.md` — SDK architecture
- **Spec**: `spec/02-app-issues/48-typescript-migration-standalone-scripts.md` — TS migration origin
