...
The spec at `/spec/06-macro-controller/workspace-management.md` listed mark-viewed as Tier 1 but the implementation had removed it. The spec and code were out of sync.
