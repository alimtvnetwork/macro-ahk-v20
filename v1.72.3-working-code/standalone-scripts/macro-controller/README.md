...
See [Migration Spec](../../spec/01-app/macrocontroller-js-to-ts-migration/README.md) for the full migration plan.
...
| Spec | Topic |
|------|-------|
| [40 — Macro Looping Reference](../../spec/12-chrome-extension/40-macro-looping-script-complete-reference.md) | Script internals |
| [42 — Data Bridge](../../spec/12-chrome-extension/42-user-script-logging-and-data-bridge.md) | `window.marco` SDK |
