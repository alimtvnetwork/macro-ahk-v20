 ...
 * See spec 20-user-script-error-isolation and 42-user-script-logging-and-data-bridge.
 *
 ...
 * (SQLite → content script relay → background handler → response).
 * See: spec/16-standalone-script-assets-pipeline.md §8 (Phase 5: Dynamic Prompts via Bridge API)
 */
