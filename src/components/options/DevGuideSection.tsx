    ...
    <div className="rounded-lg border border-border/60 bg-card/50 mt-4">
      ...
      {expanded && (
        <div className="px-4 pb-4 space-y-4 border-t border-border/40">
          ...
          <div className="mt-3 rounded-md border border-amber-500/30 bg-amber-500/5 px-3 py-2.5 flex gap-2.5">
            ...
            <div className="space-y-1.5 text-[11px] leading-relaxed">
              ...
              <p className="text-foreground/80">
                <code className="font-mono text-amber-300">RiseupAsiaMacroExt</code> and{" "}
                <code className="font-mono text-amber-300">window.marco</code> are injected into the page's{" "}
                <strong>MAIN world</strong>, only on tabs whose URL matches one of this project's URL rules
                (or the SDK's URL rules).
              </p>
              <ul className="list-disc list-inside text-foreground/70 space-y-0.5 pl-1">
                <li><strong>✅ Works in:</strong> DevTools console of a matched tab (e.g. <code className="font-mono">https://lovable.dev/projects/*</code>), and inside scripts injected by this extension.</li>
                <li><strong>❌ Does NOT work in:</strong> the popup, options page, <code className="font-mono">chrome://</code> URLs, <code className="font-mono">about:blank</code>, or any non-matched tab — you'll get <code className="font-mono">ReferenceError: RiseupAsiaMacroExt is not defined</code>.</li>
                <li><strong>Tip:</strong> in DevTools, make sure the console's <em>top-frame context</em> is selected (default), not an iframe.</li>
              </ul>
            </div>
          </div>
