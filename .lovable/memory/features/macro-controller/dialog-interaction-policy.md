...
`refreshStatus()` when loop is stopped ONLY performs passive checks: reading workspace name from the nav element and updating UI. See: `spec/02-app-issues/82-project-dialog-auto-click-when-stopped.md`
