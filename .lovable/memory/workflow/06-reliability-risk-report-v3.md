...
| **P6** | Cross-project sync spec maturation | `spec/10-features/cross-project-sync.md` | +3% for sync module | ⬜ Draft |
...
9. **Developer guide** — 10-chapter AI-ready guide in `spec/09-devtools-and-injection/developer-guide/`
